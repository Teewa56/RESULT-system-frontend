            ...
            {(current === 1 || current === 2) && (
                <div className="flex flex-col w-full p-6">
                    <div className="relative w-full flex flex-col items-start justify-start">
                        ...
                        />
                        <div className={`absolute top-10 rounded-2xl bg-gray-300 w-full flex flex-col items-start justify-start ${searchResult && searchResult.length > 0 ? 'p-2' : 'p-0'} transition-all duration-300 overflow-hidden`}>
